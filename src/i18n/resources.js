const resources = {
	en: {
		translation: {
			...
			'Topics for something you want to show': 'Topics for something you want to show',
			'Things that better not showing on front page': 'Things that better not showing on front page',
			'See Here': 'See Here',
			'Our text editor is using markdown format': 'Our text editor is using markdown format',
	...
	zh: {
		translation: {
			...
			'Topics for something you want to show': '瞧一瞧看一看，说不定有好东西哦',
			'Things that better not showing on front page': '当初建立这个站的时候可没告诉我有这些帖子会出现',
			'See Here': '阅读细则',
			'unhide': '还原可见',
			'Our text editor is using markdown format': '文字编辑采用markdown语法',
	...
	sv: {
		translation: {
			...
			'lifeBoard': 'Livstil',
			'gameBoard': 'Spel',
			'shareBoard': 'några saker att visa',
			'spamBoard': 'Spam',
			'putPostIn': 'Postat in',
			'postBy': 'Postat av ',
			'title': 'Rubrik',
	...
	de: {
		translation: {
			...
			'Change Password': 'Veränderung Passwort',
			'statistic': 'Statistik',
			...
			'lifeBoard': 'Kneipe',
			'gameBoard': 'Spielen',
			'shareBoard': 'Einige Dinge zu zeigen',
			'spamBoard': 'Spam',
